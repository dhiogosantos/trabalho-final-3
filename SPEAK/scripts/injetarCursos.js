function injetaCurso() {
    $.ajax({
        type: 'POST',
        url: '../scripts/php/carregarCursos.php',
        success: function(response) {
            ...
            cursos.forEach(curso => {
                ...
                btn.addEventListener("click", () =>{
                    //REQUISICAO AJAX DO PHP QUE IRA EFETUAR INSCRICAO
                    $.ajax({
                        type: 'POST',
                        url: '../scripts/php/inscreverCurso.php',
                        data: { idCurso: curso.idCurso },
                        success: function(response) {
                            alert(response.status)
                        },
                        error: function(error) {
                            alert("Erro na inscrição. Verifique se já não esteja inscrito!");
                        }
                    });
                })
